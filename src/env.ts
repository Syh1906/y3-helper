...
import { MultiPlayerRole, parseMultiPlayerRoles } from './multiPlayerRoles';
import {
...
class Project extends vscode.Disposable {
    ...
    private async loadMultiPlayerRoles() {
        ...
        const watcher = vscode.workspace.createFileSystemWatcher(new vscode.RelativePattern(this.uri, 'campinfo.json'));
